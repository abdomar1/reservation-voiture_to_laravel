            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div>
                                <h5 class="card-title">table de resevation </h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('cars/'.App\Models\Car::findOrFail($reservation->car_id)->image)}}" alt="Car Image" width="50">
                                    </td>
                                    <td class="text-center">{{ $reservation->user->name }}</td>
                                    <td class="text-center">{{ App\Models\Car::findOrFail($reservation->car_id)->marque }}</td>
                                    <td class="text-center">{{ $reservation->prixTTC }}</td>
                                    <td>
                                        <span class="text-success{{ now()->isAfter($reservation->dateR) ? ' text-danger' : '' }}">
                                        {{ $reservation->dateL }}
                                        </span>
                                    </td>
                                    <td><span class="text-success{{ now()->isAfter($reservation->dateR) ? ' text-danger' : '' }}">
                                        {{ $reservation->dateR }}
                                        </span>
                                    </td>
                                    <td>
                                        <form action="{{route('admin.destroy',$reservation->id)}}"  method="post" >
                                            ...
                                            onclick="return confirm('Voulez vous vraiment supprimer le reservation  ')"
