            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <a class="btn btn-primary" href="{{route('categorie.create')}}" role="button">ajoute categories</a>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div>
                                <h5 class="card-title">table de categorie </h5>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">les categories</th>
                                    <th class="text-center">number de cars </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center"><img src="{{ asset('categorie/'.$category->path) }}" alt="" width="60" class="rounded-circle border"></td>
                                    <td class="text-center">{{ $category->nameCategorie }}</td>
                                    ...
                                    <td class="text-center">
                                        <form action="{{route('categorie.destroy',$category->id)}}"  method="post" >
                                            ...
                                            <a href="{{ route('categorie.edit',$category->id) }}" style="color:blue"><i class="bi bi-pencil"></i></a>
                                            <button type="submit" style="color:red" class="btn border-none"
                                            onclick="return confirm('Voulez vous vraiment supprimer le categorie {{$category->nameCategorie}} ')"
