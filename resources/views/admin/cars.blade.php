            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <a class="btn btn-primary" href="{{route('car.create')}}" role="button">ajoute car</a>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div>
                                <h5 class="card-title">table de cars </h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach ($cars as $car)
                                <tr>
                                    <td class="text-center"><img src="{{ asset('cars/'.$car->image) }}" width="50"></td>
                                    <td class="text-center">{{$car->marque}} </td>
                                    <td class="txt-oflo">{{$car->model}}</td>
                                    <td><span class="txt-oflo">{{$car->type}}</span></td>
                                    <td><span class="txt-oflo">{{$car->prixJ}} </span></td>
                                    <td class="txt-center">{{$car->categorie->nameCategorie}}</td>
                                    <td>
                                        @if ($car->disponible)
                                        <span class="text-success">disponible</span>
                                        @else
                                        <span class="text-danger">noDisponible</span>
                                        @endif
                                        </td>
                                        <td>
                                            <form action="{{route('car.destroy',$car->id)}}"  method="post" >
                                                ...
                                                <a href="{{ route('car.edit',$car->id) }}" style="color:blue"><i class="bi bi-pencil"></i></a>
                                                <button type="submit" style="color:red" class="btn border-none"
                                                onclick="return confirm('Voulez vous vraiment supprimer le voiture {{$car->marque}} ')"
